module.exports = {
  ...
  mesErrValidation400: 'Ошибка валидации модели',
  mesErrConflict409: 'Запись с таким номером уже существует',
  mesErrFixUpdate404: 'Ошибка измения',
  mesErrId400: 'Некорректный id',
  ...
  mesErrLoginUser401: 'Такой пользователь уже есть',
  ...
  // заявители
  mesErrNoApplicant404: 'Заявители не найдены',

  // пострадавшие
  mesErrNoVictim404: 'Пострадавшие не найдены',

  //события
  mesErrNoEvent404: 'События не найдены',
};
